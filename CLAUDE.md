...
- **FR2.9** — A topic holds the student's original materials: files uploaded to that topic are kept as they are, listed with the topic, downloadable, and deletable by the student who uploaded them. Materials are private to their uploader — not shared with a Study Group in this release.
...
| **Material** | `id`, `userId`, `courseId`, `topicId`, `fileName`, `s3Key`, `fileType`, `sizeBytes`, `uploadedAt` | Private (owned by the uploading student; FR2.9) |
